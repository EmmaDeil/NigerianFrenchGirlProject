...
const Header = () => {
  return (
    <div>
      <div className='container-fluid' style={{display: 'flex', background: 'linear-gradient(135deg, darkblue 30%, white 100%)', justifyContent: 'center', alignItems: 'center', height: '500px'}}>
        <div className='header-text'style={{width: '50%'}}>
